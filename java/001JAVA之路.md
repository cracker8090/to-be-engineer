...
![Java异常类层次结构图](../../opensoucecode/JavaGuide/docs/java/images/java-exception-handling-class-hierarchy-diagram.jpg)

<p style="font-size:13px;text-align:right">图片来自：https://simplesnippets.tech/exception-handling-in-java-part-1/</p>

![Java异常类层次结构图](../../opensoucecode/JavaGuide/docs/java/images/exception-architechture-java.png)
